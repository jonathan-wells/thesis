...
% This finding was replicated using CORUM, a manually curated database of
% experimentally validated protein complexes (non-structural and excluding
% high-throughput data) compiled from the literature \cite{Ruepp2010}.
