...
\begin{figure}[h]
    \makebox[\textwidth]{\includegraphics[width=\textwidth]{c5_fig_qsdsratio}}
...
\begin{figure}[h]
    \makebox[\textwidth]{
        \includegraphics[width=\textwidth]{c5_fig_usubsdsratio}
        }
...
% NOTE: Details on interface size please.
...
\begin{figure}[h]
    \makebox[\textwidth]{\includegraphics[width=\textwidth]{c5_fig_assembly}}
...
% NOTE: Do you explicitly note the disorder thing in the last chapter?
...
\fcapsideright
    ...
    {\includegraphics[width=0.5\textwidth]{c5_fig_disorder}}
\end{figure}
...
\fcapsideright
    ...
    {\includegraphics[width=0.6\textwidth]{c5_fig_comparison}}
\end{figure}
...
\begin{figure}[h]
    \includegraphics{c5_fig_aggattrs}
